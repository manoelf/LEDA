...
public class StudentLinkedListTest {
	...
	public void streamTest5() {
		...
		Assert.assertTrue(2 == testando.getNext().getData());
	...
	public void streamTest9() {
		...
		array.remove(3);
		Assert.assertTrue(array.getData() == 1);
		Assert.assertTrue(array.getNext().getNext().getData() == null);
		
		array.remove(1);
		Assert.assertTrue(array.getData() == 2);
